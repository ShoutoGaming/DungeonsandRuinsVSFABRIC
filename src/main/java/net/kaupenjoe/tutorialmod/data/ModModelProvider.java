...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerCubeAllModelTexturePool(ModBlocks.BOX);
        blockStateModelGenerator.registerCubeAllModelTexturePool(ModBlocks.LOOTCHEST);
        ...
        blockStateModelGenerator.registerParentedItemModel(ModItems.ROYAL_GUARD_SPAWN_EGG, ModelIds.getMinecraftNamespacedItem("template_spawn_egg"));
        blockStateModelGenerator.registerParentedItemModel(ModItems.GREAT_HUNTER_SPAWN_EGG, ModelIds.getMinecraftNamespacedItem("template_spawn_egg"));
        blockStateModelGenerator.registerParentedItemModel(ModItems.WRAITH_SPAWN_EGG, ModelIds.getMinecraftNamespacedItem("template_spawn_egg"));
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(ModItems.TOXIC_HELMET, Models.GENERATED);
        itemModelGenerator.register(ModItems.TOXIC_CHESTPLATE, Models.GENERATED);
        itemModelGenerator.register(ModItems.TOXIC_LEGGINGS, Models.GENERATED);
        itemModelGenerator.register(ModItems.TOXIC_BOOTS, Models.GENERATED);
    }
}
