...
public class LootchestBlock extends BlockWithEntity {

    public LootchestBlock(Settings settings) {
        super(settings);
    }
    @Nullable
    @Override
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (!world.isClient) {
            ...
            if (be instanceof LootChestBlockEntity) {
                // Aquí es donde especificas el ítem que quieres que suelte tu bloque.
                ItemStack drop = new ItemStack(Items.DIAMOND, 1);
