...
import net.kaupenjoe.tutorialmod.block.custom.BoxBlock;
import net.kaupenjoe.tutorialmod.block.custom.LootchestBlock;
import net.kaupenjoe.tutorialmod.block.custom.ValvuleBlock;
...
public class ModBlocks {
    ...
    public static final Block VALVULE = registerBlock("valvule",
            new ValvuleBlock(FabricBlockSettings.of(Material.METAL).strength(4.0f).requiresTool()), ModItemGroup.CITRINE);
    public static final Block BOX = registerBlock("box",
            new BoxBlock(FabricBlockSettings.of(Material.METAL).strength(4.0f).requiresTool()), ModItemGroup.CITRINE);
    ...
    public static final Block LOOTCHEST = registerBlock("lootchest",
            new LootchestBlock(FabricBlockSettings.of(Material.METAL).strength(4.0f).requiresTool()), ModItemGroup.CITRINE);
